#!/usr/bin/env python3
"""
Upload index.html to /public_html/downloads/ to replace directory listing
"""
...
def main():
    print("=" * 60)
    print("Uploading index.html to /public_html/downloads/")
    print("=" * 60)
    print()
    ...
    try:
        ...
        if os.path.exists(index_path):
            ...
            if upload_file(ftp, index_path, 'index.html'):
                ...
                print("=" * 60)
                print()
                print("The directory listing should now be replaced with index.html.")
